...
static const char col_gray1[]       = "#24273a"; // Background
static const char col_gray2[]       = "#f5a97f"; // Orange
static const char col_gray3[]       = "#cad3f5"; // 
static const char col_gray4[]       = "#181926";
static const char col_cyan[]        = "#91d7e3";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_0,      view,           {.ui = ~0 } }, // See all tags
	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } }, // See window in all tags
 	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
